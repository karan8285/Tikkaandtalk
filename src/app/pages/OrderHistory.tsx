...
import { Clock, MapPin, ShoppingBag, ChevronDown, ChevronUp, RefreshCw, Package, RotateCw } from "lucide-react";
...
export default function OrderHistory() {
  ...
  const getPointsStatus = (order: Order) => {
    ...
    if (order.status === 'closed' && !order.paymentReceived) {
      return {
        message: `⏳ ${pointsAmount} points pending payment`,
        color: "#D91A60"
      };
    }
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          <h3 className="font-semibold">Order {order.orderNumber || `#${order.id.substring(0, 8).toUpperCase()}`}</h3>
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-lg mb-1" style={{ color: '#D91A60' }}>
